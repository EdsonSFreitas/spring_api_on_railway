...
class UserControllerTest {
    ...
    void testFindById() {
        ...
        ResponseEntity<UserCompleteDTO> actualFindByIdResult = userController.findById(UUID.randomUUID());
    ...
    void testFindByIdParam() {
        ...
        when(repository.findById(Mockito.<UUID>any())).thenReturn(ofResult);
        UserController userController = new UserController();
        ResponseEntity<UserCompleteDTO> actualFindByIdParamResult = userController.findByIdParam(UUID.randomUUID());
